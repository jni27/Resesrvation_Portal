...
//INDEX- show reservation page
router.get("/" ,function(req, res){
    Customer.find({}, function(err, allCustomer){
        if(err){
            console.log(err);
        }else{
            res.render("reservation", {customers: allCustomer});
        }
    });
...
router.post("/", function(req, res){
    ...
    var newCustomer = new Customer({name:Custname, portal: portal, date: date,time: time, contact: contact});
